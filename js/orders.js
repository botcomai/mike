...
function renderOrders(data) {
  ...
  data.forEach((order) => {
    ...
    row.innerHTML = `
      ...
      <td data-label="Delivered">${isDelivered ? '<b style="color:#059669;">YES</b>' : '<b style="color:#ef4444;">NO</b>'}</td>
