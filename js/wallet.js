  ...
  paystack.newTransaction({
    ...
    onSuccess: async function(response){
      ...
      try {
        ...
        if (error) throw new Error(error.message || "Failed to communicate with verification server.");
        ...
        if(window.showErrorPopup) {
          window.showErrorPopup("Critical Error", "Verification failed. Please use 'Verify Transaction' if balance is not updated: " + err.message);
        } else {
